...
bool CliqueStack::empty() const {
  // Return whether the cliqueStack object has been initialised.
  // Since stack may be initialised with zero entries as an edge case, keep
  // track of stack size in a variable which is negative when uninitialised.
