...
class FHsolver {
 ...
 public:
  ...
  Int64 analyse(Symbolic& S, const std::vector<Int64>& rows,
                const std::vector<Int64>& ptr, const std::vector<Int64>& signs);
  ...
  // See ReturnValues.h for errors.
  Int64 factorise(const Symbolic& S, const std::vector<Int64>& rows,
