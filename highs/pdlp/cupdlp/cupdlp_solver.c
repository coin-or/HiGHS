...
void iterReport(char* message, CUPDLPwork *pdhg) {
  ...
  //  for (int iCol = 0; iCol < problem->data->nCols; iCol++) printf("%11.5g,", iterates->x->data[iCol]);
  printf("y,");
  //  for (int iRow = 0; iRow < problem->data->nRows; iRow++) printf("%11.5g,", iterates->y->data[iRow]);
