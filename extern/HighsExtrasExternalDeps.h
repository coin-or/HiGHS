...
using blas_methods = std::tuple<
    ...
    decltype(&cblas_dnrm2), decltype(&cblas_dgemv), decltype(&cblas_dtpsv),
...
struct blas : extras_feature<1> {
  ...
  static size_t idamax(blasint n, const double* dx, blasint incx) {
  ...
  static size_t dnrm2(blasint n, const double* dx, blasint incx) {
    return impl::template fn<6>()(n, dx, incx);
  }
  ...
  static void dgemv(enum CBLAS_ORDER order, enum CBLAS_TRANSPOSE transa,
    ...
    impl::template fn<7>()(order, transa, M, n, alpha, A, lda, x, incx, beta, y,
                           incy);
  }
  ...
  static void dtpsv(enum CBLAS_ORDER order, enum CBLAS_UPLO uplo,
    ...
    impl::template fn<8>()(order, uplo, transa, diag, n, ap, x, incx);
  }
  ...
  static void dtrsv(enum CBLAS_ORDER order, enum CBLAS_UPLO uplo,
                    ...
                    blasint incx) {
    impl::template fn<9>()(order, uplo, transa, diag, n, A, lda, x, incx);
  }
  ...
  static void dger(enum CBLAS_ORDER order, blasint m, blasint n, double alpha,
    ...
    impl::template fn<10>()(order, m, n, alpha, x, incx, y, incy, A, lda);
  }
  ...
  static void dgemm(enum CBLAS_ORDER order, enum CBLAS_TRANSPOSE transa,
                    ...
                    blasint ldc) {
    impl::template fn<11>()(order, transa, transb, m, n, k, alpha, A, lda, B,
                            ldb, beta, C, ldc);
  }
  ...
  static void dsyrk(enum CBLAS_ORDER order, enum CBLAS_UPLO uplo,
    ...
    impl::template fn<12>()(order, uplo, trans, n, k, alpha, A, lda, beta, C,
                            ldc);
  }
  ...
  static void dtrsm(enum CBLAS_ORDER order, enum CBLAS_SIDE side,
    ...
    impl::template fn<13>()(order, side, uplo, transa, diag, m, n, alpha, A,
                            lda, B, ldb);
  }

  static void openblas_set_num_threads(int num_threads) {
    impl::template fn<14>()(num_threads);
  }
};
